...
# We train a classical neural network 10 times and randomise the labels. This script has 0.4 randomisation
from abc import ABC, abstractmethod

np.random.seed(42)

# We train a classical neural network to zero training error 10 times and randomise the labels \
# This script has 40% label randomisation
...
for l in range(100):
    ...
    for i in range(int(0.4*len(y_train))):
