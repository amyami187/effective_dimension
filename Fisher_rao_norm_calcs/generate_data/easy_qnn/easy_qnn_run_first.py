...
# This code trains a fixed easy quantum model 100 times and stores the trained sets of parameters after \
# 100 training iterations in order to compute the Fisher-Rao norm
